function [tmin,xfeas] = feasp2(LMIsys,options,target)
% FEASP   Compute a solution to a given LMI system
%
%   [TMIN,XFEAS] = FEASP(LMISYS,OPTIONS,TARGET) solves the feasibility 
%   problem defined by the system of LMI constraints, LMISYS.  When the 
%   problem is feasible, the output XFEAS is a feasible value of the vector
%   of (scalar) decision variables.
%
...
%
%   Input:
%    LMISYS    Array describing the system of LMI constraints
...
%   $Revision: 1.1.6.3 $ $Date: 2009/02/06 14:23:33 $
